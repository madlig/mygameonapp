// src/features/landing/components/GameCard.jsx
//
// Komponen card game standalone (non-Algolia).
...
const GameCard = ({ game }) => {
  ...
  // Version (schema baru: fileVersion)
  const fileVersion =
  ...
  // Tags (tidak berubah, masih pakai game.tags[])
