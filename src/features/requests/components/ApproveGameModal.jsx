...
import { X, Save, Loader2, HardDrive, Link as LinkIcon, Gamepad2, Image as ImageIcon, Tag, Hash, GitBranch, AlignLeft } from 'lucide-react';
...
const ApproveGameModal = ({ request, onClose, onSuccess }) => {
  const { register, handleSubmit, formState: { errors, isSubmitting } } = useForm({
    defaultValues: {
      ...
      status: 'Available',
      coverUrl: ''         // Opsional untuk gambar
    }
  });
  ...
  const onSubmit = async (data) => {
    try {
      ...
      const gameData = {
        ...
        genre: data.genre.split(',').map(g => g.trim()).filter(g => g !== ''), 
        
        // Location diisi Link Download (sesuai request Anda)
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 backdrop-blur-sm p-4 animate-in fade-in">
      <div className="bg-white rounded-xl shadow-2xl w-full max-w-3xl overflow-hidden max-h-[90vh] overflow-y-auto">
        ...
        <div className="px-6 py-4 border-b border-slate-100 flex justify-between items-center bg-slate-50 sticky top-0 z-10">
          <div>
            <h3 className="font-bold text-slate-800 text-lg">Finalisasi ke Katalog</h3>
            <p className="text-slate-500 text-xs">Data disesuaikan dengan standar GameFormModal.</p>
          </div>
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="p-6">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div className="space-y-4">
              {/* Name */}
              <div>
                <label className="block text-sm font-medium text-slate-700 mb-1">Nama Game</label>
              ...
              <div className="grid grid-cols-2 gap-4">
                <div>
                    ...
                    <div className="relative">
                        <GitBranch className="absolute top-2.5 left-3 text-slate-400" size={18} />
                        <input 
                        {...register("version")}
                        placeholder="v1.0"
                        className="w-full pl-10 pr-3 py-2 border rounded-lg focus:ring-2 focus:ring-blue-500 outline-none"
              ...
              <div>
                ...
                <div className="relative">
                    <Tag className="absolute top-2.5 left-3 text-slate-400" size={18} />
                    <input 
              ...
              <div>
                ...
                <select {...register("status")} className="w-full px-3 py-2 border rounded-lg bg-white focus:ring-2 focus:ring-blue-500 outline-none">
            ...
            <div className="space-y-4">
              ...
              <div className="grid grid-cols-3 gap-2">
                <div className="col-span-2">
                    <label className="block text-sm font-medium text-slate-700 mb-1">Ukuran (Size)</label>
                    <div className="relative">
                        <HardDrive className="absolute top-2.5 left-3 text-slate-400" size={18} />
                        <input 
                        type="number"
                        step="0.01"
                ...
                <div>
                    ...
                    <select {...register("unit")} className="w-full px-3 py-2 border rounded-lg bg-white focus:ring-2 focus:ring-blue-500 outline-none">
              ...
              {/* Jumlah Part */}
              <div>
                <label className="block text-sm font-medium text-slate-700 mb-1">Jumlah Part</label>
                <div className="relative">
                    <Hash className="absolute top-2.5 left-3 text-slate-400" size={18} />
                    <input 
                    type="number"
                    {...register("jumlahPart", { required: "Wajib diisi", min: 1 })}
                    className="w-full pl-10 pr-3 py-2 border rounded-lg focus:ring-2 focus:ring-blue-500 outline-none"
                    placeholder="1"
                    />
                </div>
              ...
              <div>
                <label className="block text-sm font-medium text-slate-700 mb-1">Link GDrive (Location)</label>
                <div className="relative">
                    <LinkIcon className="absolute top-2.5 left-3 text-slate-400" size={18} />
                    <input 
              ...
              <div>
                ...
                <div className="relative">
                    <ImageIcon className="absolute top-2.5 left-3 text-slate-400" size={18} />
                    <input 
                    {...register("coverUrl")}
          ...
          <div className="mt-4">
            ...
            <div className="relative">
                <AlignLeft className="absolute top-3 left-3 text-slate-400" size={18} />
                <textarea 
