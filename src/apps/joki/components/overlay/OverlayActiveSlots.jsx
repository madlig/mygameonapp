    ...
    switch (theme) {
      case 'gold':
        return {
          ...
          slotBadge: 'bg-amber-400 text-black border-amber-300',
          badgeVvip: 'bg-rose-500/25 text-rose-200 border-rose-400/50',
          badgeVip: 'bg-amber-400/25 text-amber-200 border-amber-300/50',
          badgeBasic: 'bg-white/10 text-slate-300 border-white/20',
      ...
      case 'crimson':
        return {
          ...
          slotBadge: 'bg-rose-500 text-white border-rose-400',
          badgeVvip: 'bg-rose-500/30 text-rose-100 border-rose-400/50',
          badgeVip: 'bg-amber-400/25 text-amber-200 border-amber-300/50',
          badgeBasic: 'bg-white/10 text-slate-300 border-white/20',
      ...
      case 'dark':
        return {
          ...
          slotBadge: 'bg-slate-700 text-white border-white/30',
          badgeVvip: 'bg-rose-500/25 text-rose-200 border-rose-400/40',
          badgeVip: 'bg-amber-400/25 text-amber-200 border-amber-300/40',
          badgeBasic: 'bg-white/10 text-slate-300 border-white/20',
      ...
      default:
        return {
          ...
          accentText: 'text-cyan-400',
          slotBadge: 'bg-cyan-400 text-black border-cyan-300 shadow-md shadow-cyan-400/30',
          badgeVvip: 'bg-rose-500/25 text-rose-100 border-rose-400/50 shadow-rose-500/20',
          badgeVip: 'bg-amber-400/25 text-amber-200 border-amber-300/50 shadow-amber-500/20',
          badgeBasic: 'bg-cyan-500/20 text-cyan-200 border-cyan-400/35',
